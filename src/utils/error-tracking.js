const _rollbarConfig = {
  accessToken: '3c37fcb85f894bfebf1b6057ff714ee4',
    ...
    function(r, e) {
      ...
      function t(r, e, o) {
        window._rollbarWrappedError &&
          (o[4] || (o[4] = window._rollbarWrappedError),
      ...
      function i(r) {
        ...
        return o(function() {
          ...
          var n = Array.prototype.slice.call(arguments, 0),
            a = { shim: o, method: r, args: n, ts: new Date() };
        ...
        return o(function() {
          ...
          return (
            e.captureUnhandledRejections &&
              ((i._unhandledRejectionHandler = function(r) {
                var e = r.reason,
                  o = r.promise,
                  t = r.detail;
                !e && t && ((e = t.reason), (o = t.promise)),
                  i.unhandledRejection(e, o);
              }),
              r.addEventListener(
                'unhandledrejection',
                i._unhandledRejectionHandler,
              )),
            (r[t] = i),
            i
          );
      ...
      for (
        var d = 'log,debug,info,warn,warning,error,critical,global,configure,scope,uncaughtError,unhandledRejection'.split(
            ',',
          ),
          p = 0;
        p < d.length;
      ...
      r.exports = { Rollbar: a, _rollbarWindowOnError: t };
    },
    function(r, e) {
      'use strict';
